    ...
    <div className="w-full max-w-3xl mx-auto p-8 bg-slate-800 rounded-xl shadow-2xl flex flex-col items-center gap-6 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row gap-8 w-full justify-center text-center">
        ...
        <div className="p-4 flex-1">
          ...
          <p className="text-slate-400">Độ chính xác</p>
        </div>
        <div className="border-l border-slate-700 hidden md:block"></div>
        <div className="p-4 flex-1">
      ...
      <button
        onClick={onRestart}
        className="mt-4 px-8 py-3 bg-cyan-500 text-slate-900 font-bold rounded-lg hover:bg-cyan-400 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-cyan-300"
      >
        Thử bài hát khác
      </button>
    </div>
